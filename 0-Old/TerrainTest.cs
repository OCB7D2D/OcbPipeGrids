...
public class TerrainTestCmd : ConsoleCmdAbstract
{
    ...
    protected override string[] getCommands() => new string[1] { "tst" };

    protected override string getDescription() => "Test commands";

    protected override string getHelp() => "Test commands:";
