namespace NodeManager
{
    ...
    public class NetPkgActionRemoveSource : NetPkgWorkerAction<ActionRemoveSource> { }
    public class NetPkgActionAddPump : NetPkgWorkerAction<ActionAddPump> { }
    public class NetPkgActionRemovePump : NetPkgWorkerAction<ActionRemovePump> { }
    public class NetPkgActionAddReservoir : NetPkgWorkerAction<ActionAddReservoir> { }
    public class NetPkgActionRemoveReservoir : NetPkgWorkerAction<ActionRemoveReservoir> { }
    public class NetPkgActionAddWell : NetPkgWorkerAction<ActionAddWell> { }
    public class NetPkgActionRemoveWell : NetPkgWorkerAction<ActionRemoveWell> { }
    public class NetPkgActionAddFluidConverter : NetPkgWorkerAction<ActionAddFluidConverter> { }
