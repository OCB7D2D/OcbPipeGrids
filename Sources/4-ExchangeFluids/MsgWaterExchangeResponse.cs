...
{
    public class MsgWaterExchangeResponse : ServerNodeResponse<NetPkgWaterExchangeResponse>
    {
        ...
        public override void ProcessAtClient(NodeManagerClient client)
        {
            ...
            if (bv.Block is BlockFarmWell well)
                well.OnFillStateChanged(Position, FillLevel);
