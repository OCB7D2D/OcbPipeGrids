...
namespace NodeFacilitator
{
    ...
    public class PlantationFarmPlot : PipeReservoir, IFarmPlot
    {
        ...
        public byte CurrentLight => CurrentGrowLight;

        public byte CurrentGrowLight { get; set; } = 0;
        ...
        public PlantationFarmPlot(Vector3i position, BlockValue bv) : base(position, bv)
        {
            GetBlock(out BLOCK);
        }
        ...
        public override bool Tick(ulong delta)
        {
            ...
            {
                CurrentGrowLight = 0;
                foreach (IGrowLight light in GrowLights)
                    CurrentGrowLight = System.Math.Max(
                        CurrentGrowLight, (byte)18);
            }
            // Keep ticking
            return true;
        }
